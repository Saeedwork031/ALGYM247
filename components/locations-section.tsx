        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="animate-fade-in-up">
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="space-y-2 text-muted-foreground">
                      <div className="flex items-start gap-2 group/item">
                        <MapPin className="w-4 h-4 mt-1 text-primary transition-all duration-300 group-hover/item:scale-110 group-hover/item:text-green-500" />
                      ...
                      <div className="flex items-center gap-2 group/item">
                        <Phone className="w-4 h-4 text-primary transition-all duration-300 group-hover/item:scale-110 group-hover/item:text-green-500" />
                        <span className="text-sm transition-colors duration-300 group-hover:text-foreground">
                          {location.phone}
                        </span>
                      </div>
                      ...
                      <div className="flex items-center gap-2 group/item">
                        <Clock className="w-4 h-4 text-primary transition-all duration-300 group-hover/item:scale-110 group-hover/item:text-green-500" />
            ...
            <Button
              ...
              onClick={() => {
                const message = encodeURIComponent("¡Hola! Me interesa conocer más sobre las ubicaciones de Algym247 y sus servicios.")
          ...
          <div className="relative animate-fade-in-right">
            <img
              src="/pic3.jpg"
              alt="Persona entrenando en Algym247"
              className="w-full h-[500px] object-cover rounded-lg shadow-lg transition-all duration-500 hover:shadow-2xl hover:scale-[1.02] transform-gpu"
            />
