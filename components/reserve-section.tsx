        ...
        <div className="relative bg-white rounded-2xl shadow-lg p-12 md:p-16 text-center transition-all duration-300 hover:shadow-xl hover:scale-[1.01] transform-gpu">
          ...
          <div className="relative z-10 space-y-8">
            ...
            <div className="pt-4">
              <Button
                size="lg"
                className="group relative overflow-hidden bg-gray-800 hover:bg-gray-900 text-white px-8 py-4 rounded-lg text-lg font-medium transition-all duration-300 hover:scale-105 hover:shadow-xl transform-gpu"
                onClick={() => window.open("https://wa.me/5215512345678?text=Hola, me interesa reservar mi lugar en Algym247", "_blank")}
              >
                <svg
